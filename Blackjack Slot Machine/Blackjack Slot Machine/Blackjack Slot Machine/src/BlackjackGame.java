...
public class BlackjackGame {
	...
	public void initializeGame(){
		...
		// Asks user to enter the account name
        ...
        if (file.exists())
        	...
        	//System.out.println (mygame.endGame());
	}
	...
	public boolean forceEnd() {
		...
		{
			System.out.println("");
			System.out.println("You have insufficient funds, please deposit some money before proceeding");
		}
